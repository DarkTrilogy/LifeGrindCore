...
export const TasksPage = () => (
  <>
    <PageMetaTags
      title={`Organize and Manage Your Tasks Efficiently | lifegrindcore Task Management`}
      description={`Stay on top of your workload with lifegrindcore's powerful task management feature. Organize tasks by deadlines, prioritize projects, and track progress to boost your productivity and achieve your goals. Try lifegrindcore today!`}
    />
    <VStack>
      <TasksSlice />
    </VStack>
