...
const videoSlices: FeatureVideoSliceProps[] = [
  ...
  },
  {
    ...
    subtitle:
      'Monitor your productivity by tracking the time spent on each task. lifegrindcore helps you stay on top of your workload and ensures every minute is accounted for.',
  },
]
