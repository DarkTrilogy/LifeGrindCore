...
export const trackTimeEducation: ProductToolEducation = {
  ...
  content: (
    <>
      ...
      <p>
        If you forget to start or stop a session, lifegrindcore gives you the
      ...
      <p>
        Time Tracking seamlessly integrates with other lifegrindcore tools,
      ...
      <p>
        Time Tracking in lifegrindcore is not just about logging hours—it’s about
