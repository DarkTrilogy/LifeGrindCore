...
export const habitsEducation: ProductToolEducation = {
  ...
  subtitle: `The Habits tool is designed to help you build and maintain consistent
        ...
        toward becoming the person you want to be. The Habits page in lifegrindcore
  ...
  content: (
    <>
      ...
      <p>
        To keep habit tracking easy and accessible, lifegrindcore adds a reminder to
      ...
      <p>
        The Habits tool in lifegrindcore empowers you to shape and reinforce the
