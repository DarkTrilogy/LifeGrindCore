...
export const tasksEducation: ProductToolEducation = {
  ...
  subtitle: `Efficient task management is key to staying organized and productive. In lifegrindcore, you can easily create, prioritize, and track tasks across projects, helping you stay focused on what matters most. Whether you're managing daily to-dos or long-term goals, this guide will show you how to use lifegrindcore's task management tools to streamline your workflow and achieve your objectives.`,
  youTubeVideoUrl: infoYouTubeVideos.tasks,
  content: (
    <>
      <h2>Task Creation and Organization</h2>
      <p>
        In lifegrindcore, the "Tasks" page is designed to help you manage your
      ...
      <p>
        Task management in lifegrindcore connects seamlessly with other tools like
      ...
      <p>
        By using lifegrindcore's task management features, you can keep your work
        ...
        lifegrindcore's task management tools empower you to stay productive and
